...
public final class ConsumerUtils {
    ...
    public static BrokerEndPoint getNewLeader(SimpleConsumer consumer, String topic, int partition) {
    ...
    public static long getOffsetBefore(SimpleConsumer consumer, String topic, int partition, long whichTime, int attempts){
        ...
        for(int i = 0; i < attempts; i++) {
            try {
                ...
                if (i < attempts - 1) {
                    BrokerEndPoint leader = getNewLeader(consumer, topic, partition);
    ...
    public static Pair<ConsumerConnector, Map<String, List<KafkaStream<Bundle, Bundle>>>> newBundleStreams(
        ...
        return new ImmutablePair<>(
                connector,
                connector.createMessageStreams(topicStreams, new BundleDeserializer(), new BundleDeserializer()));
    }
